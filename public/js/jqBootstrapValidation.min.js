...
! function(m) {
                        ...
                        m.each(n, function(a, t) {
                            ...
                            t.find("input,textarea,select").each(function(a, e) {
                                ...
                                if (m.each(m(e).triggerHandler("validation.validation", n), function(a, e) {
                                        o.push(e)
                                    }), o.length > t) m(e).attr("aria-invalid", "true");
                                else {
    ...
    m.fn.jqBootstrapValidation = function(a) {
        return t.methods[a] ? t.methods[a].apply(this, Array.prototype.slice.call(arguments, 1)) : "object" != typeof a && a ? (m.error("Method " + a + " does not exist on jQuery.jqBootstrapValidation"), null) : t.methods.init.apply(this, arguments)
